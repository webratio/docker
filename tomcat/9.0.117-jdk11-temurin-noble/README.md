...
2. Pull the image 
  * `docker pull webratio/tomcat:9.0.117-jdk11-temurin-noble`

### Image creation

1. Create and push the image
  * `docker buildx build --platform linux/amd64,linux/arm64 -t webratio/tomcat:9.0.117-jdk11-temurin-noble --push .`